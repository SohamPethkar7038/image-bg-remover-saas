    ...
    <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 items-start'>
        ...
        <div className='grid grid-cols-1'>
          ...
          <div className='rounded-md border border-gray-300 min-h-53  relative bg-layer overflow-hidden'>
      ...
      <div className='flex justify-center sm:justify-center items-center flex-wrap gap-4 mt-4'>
